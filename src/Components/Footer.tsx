      ...
      <div className='footer-content'>
        ...
        <div>
          <div className='flex justify-evenly'>
            <div className='css-srfjoq'>
              <h2 className='text-2xl font-bold'>Enviable for</h2>
            ...
            <div className='css-srfjoq'>
              <h2 className='text-2xl font-bold'>Terms for</h2>
              <div className='css-2xph3x'>
          ...
          <div className=''>
            <div className=' flex items-center justify-center gap-5'>
              <a target='_blank' href='https://twitter.com/enviable_trans'>
                <svg width={30} height={30} stroke='red' fill='red' stroke-width='0' viewBox='0 0 16 16' focusable='false' className='chakra-icon css-167j8ub' xmlns='http://www.w3.org/2000/svg'>
              ...
              <a target='_blank' href='https://www.linkedin.com/company/enviabletransport/'>
                <svg
                  ...
                  viewBox='0 0 16 16'
                  focusable='false'
                  className='chakra-icon css-167j8ub'
              ...
              <a target='_blank' href='https://www.instagram.com/enviable_transport'>
                <svg width={30} height={30} stroke='red' fill='red' stroke-width='0' viewBox='0 0 448 512' focusable='false' className='chakra-icon css-167j8ub' xmlns='http://www.w3.org/2000/svg'>
